...
var referenciasContext =
{
    ...
    GenerarReferencia: function (Matricula, Escuela, Semestre, Ciclo, Movimiento, Nombre, DiasVigencia, Extemporaneo, Carrera, callBackResult) {
        var self = this;
        ...
        $.ajax(
            {
                ...
                data: { Matricula, Escuela, Semestre, Ciclo, Movimiento, Nombre, Carrera , DiasVigencia, Extemporaneo},
                success: function (resp) {
                    if (resp.ERROR == false) {
                        for (var i = 0; i < resp.RESULTADO.length; i++) {
